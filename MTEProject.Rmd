...
Use metabolic rate, temperature, and size data to calculated fitted exponent and activation energy for the taxonomic classes for which we could find data. 
...
Use two masses from each 3* pair and MTE to calculate metabolic rates or masses for initial, final, constant mass, and constant metabolic rate conditions. 
...
head(three_degree_pairs[,13:16])

```

#### EXPLORATORY STATS AND FIGURES

Percent differences plots
